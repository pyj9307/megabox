...
//	}
    ...
    // 회원가입 처리 - shop꺼 jpa로 처리. 패스워드 인코딩 작업은 중지시킴.
...
//	}
    ...
    // 로그인 폼 창 - shop꺼 쓸일 없어보임(헤더에 직접 주소 찍어놔서)
...
//	}
	...
	// 마이 페이지 타임리프 적용되는거 알았음. 타임리프로 로그인 시 세션에 저장된 값 찾아서 넣었고, 뷰에 타임리프 문법으로 뿌려짐(완성). 헤더 푸터 미작동 상태
