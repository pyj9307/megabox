		...
		<div class="page-util">
			...
			<div class="inner-wrap">
				<div class="lnb-area addchat">
					<nav id="lnb" class="ty2">
						<p class="tit"><a href="/movie/customer" title="고객센터">고객센터</a></p>
						<ul>
			...
			<div id="contents" class="">
				...
				<div class="btn-group pt40">
					<a href="javascript:location.href='<%=cp%>/movie/updated?num=${dto.num }&${params }';" class="button purple large" title="수정">수정</a>
					<a href="javascript:location.href='<%=cp%>/movie/deleted_ok?num=${dto.num }&${params }';" class="button purple large" title="삭제">삭제</a>
					<a href="javascript:location.href='<%=cp%>/movie/list?${params }';" class="button large" title="리스트">리스트</a>
				</div>
			</div>
		</div>
	</div>
