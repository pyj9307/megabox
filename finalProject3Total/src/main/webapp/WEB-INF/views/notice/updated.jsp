		...
		<div class="page-util">
			<div class="inner-wrap">
				<div class="location">
					...
					<a href="/movie/list" title="공지사항 페이지로 이동">공지사항 수정</a>
				</div>
				...
				<div class="lnb-area addchat ">
					<nav id="lnb" class="ty2">
						...
						<ul>
							...
							<li class=""><a href="/movie/list2" title="1:1문의">1:1문의</a></li>
					...
					<div id="contents" class="">
						...
						<div class="table-wrap">					
							...
							<br/><br/>
							<div id="bbsCreated_footer" style="text-align: center;">
								...
								<input type="button" value=" 수정취소 " class="button large" onclick="javascript:location.href='<%=cp%>/movie/list?${params }';"/>
							</div>
