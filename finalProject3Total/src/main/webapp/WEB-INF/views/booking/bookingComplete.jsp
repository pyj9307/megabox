...
<body>
	<div class="body-wrap">
		<link rel="stylesheet" href="/resources/js/main.css"
			media="all">
		<div class="container">
			<div id="contents">
				<!-- inner-wrap -->
...
$( function() {
	...
	$("#movieImg").attr("src", "/poster/" + movieImg_value);
								...
								<div class="movie-infomation-area">
									...
									<div class="movie-info-bottom">
										<div class="add-send">
											...
											<!-- 예매정보 추가 발송 -->
											<a
												href="booking/payment-successcomplete#tooltip01_01"
										...
										<div class="point-save">
											...
											<section id="cash_back" class="modal-layer"> <a
												href="booking/payment-successcomplete"
		...
		<div class="quick-area">
			<a href="booking/payment-successcomplete"
