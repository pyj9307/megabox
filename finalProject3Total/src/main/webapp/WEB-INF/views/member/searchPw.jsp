...
<link rel="stylesheet" href="../resources/js/megabox.min.css" media="all" />
...
<script src="/resources/js/common/mega.prototype.js"></script>
	...
	<div class="ap_wrapper">
		...
		<div id="ap_container" class="ap_container">
			...
			<div style="text-align : center;">
				<img style="width: 140px; " src="/resources/common/ci/logo_new2.png" alt="메인로고">
			</div>
				</br>
				</br>
				</br>
