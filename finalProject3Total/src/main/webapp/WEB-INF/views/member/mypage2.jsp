...
<meta property="og:url" id="fbUrl"
	content="booking?rpstMovieNo=22004700">
		...
		<div class="wrap"
			...
			<div class="layer-con" style="height: 511px;">
				...
				<div class="tab-list tab-layer">
					<ul>
						<li class="on"><a
							href="booking#login_tab_01"
							title="회원 로그인 선택">회원 로그인<!--회원 로그인--></a></li>
						<li><a href="booking#login_tab_02"
				...
				<div class="tab-cont-wrap">
					...
					<div id="login_tab_01" class="tab-cont on">
						<a href="booking" class="ir"></a><a
							href="booking" class="ir" title="로그인"></a>
									...
									<div class="login-input-area">
										...
										<div class="link">
											<a href="user-find"
												...
												href="join" title="회원가입 선택">회원가입<!--회원가입--></a>
											<a
					...
					<div id="login_tab_02" class="tab-cont">
						...
						<div class="login-member col-2">
							...
							<div class="btn-group">
								...
								<a id="aNonMbLogin"
									href="booking#layer_no_member_chk"
...
<!-- 여기부터 헤더 시작!!!!!!!!!!!!!!!!!!!!!!!!!1 -->
		...
		<header id="header">
		<h1 class="ci">
			<a href="" title="MEGABOX 메인으로 가기">MEGABOX
				: Life Theater</a>
		</h1>
    ...
    $(function(){
		...
		<div class="util-area">
			<div class="left-link">
				<a href="benefit/viplounge"
					title="VIP LOUNGE">VIP LOUNGE</a> <a
					href="benefit/membership" title="멤버십">멤버십</a>
			...
			<div class="right-link">
				...
				<div class="after" style="">
					<a href="/movie/login"
						...
						href="booking" class="notice" title="알림">알림</a>
    ...
    --> <nav id="gnb" class="">
		<ul class="gnb-depth1">
			...
			<li class=""><a href="theater/list"
				class="gnb-txt-theater" title="극장">극장</a>
				<div class="gnb-depth2">
					<ul>
						<li><a href="theater/list"
							title="전체극장">전체극장</a></li>
						<li><a href="specialtheater/list"
							title="특별관">특별관</a></li>
					</ul>
				</div></li>
			...
			<div class="wrap">
				...
				<div class="list position-6">
					...
					<ul class="list-depth mymage">
						...
						<li><a href="mypage/bookinglist"
							title="예매/구매내역">예매/구매내역</a></li>
						<li><a href="mypage/movie-coupon"
							title="영화관람권">영화관람권</a></li>
						<li><a href="mypage/store-coupon"
							title="스토어교환권">스토어교환권</a></li>
						<li><a
							href="mypage/discount-coupon"
							title="할인/제휴쿠폰">할인/제휴쿠폰</a></li>
						<!-- <li><a href="/on/oh/ohh/Mvtckt/GiftCardL.do">기프트카드</a></li> -->
						<li><a href="mypage/point-list"
							title="멤버십포인트">멤버십포인트</a></li>
						<li><a href="mypage/moviestory"
							title="나의 무비스토리">나의 무비스토리</a></li>
						<li><a href="mypage/myevent"
							title="나의 이벤트 응모내역">나의 이벤트 응모내역</a></li>
						<li><a href="mypage/myinquiry"
							title="나의 문의내역">나의 문의내역</a></li>
						<li><a href="mypage/mydiscount"
							title="자주쓰는 할인 카드">자주쓰는 할인 카드</a></li>
						<li><a
							href="on/oh/ohh/Mypage/mainPage.do?returnURL=info"
		...
		<div id="layer_mymega" class="header-layer layer-mymege">
			...
			<div class="wrap" style="display: none">
				...
				<div class="login-after">
					...
					<div class="box">
						<div class="coupon">
							...
							<div class="btn-fixed">
								<a href="mypage/discount-coupon"
									class="button" title="쿠폰">쿠폰</a> <a
									href="mypage/movie-coupon"
					...
					<div class="box">
						...
						<div class="btn-fixed">
							<a href="mypage/bookinglist?tab=02"
				...
				<div class="login-before">
					...
					<div class="mb50">
						<a href="booking#layer_login_common"
...
/*     $("#frameBokdMBooking").load(function(){
    ...
    ////////////////////////////////////////////////////////////////////////////
		...
		<div class="quick-area">
			<a href="booking" class="btn-go-top"
				title="top">top</a>
		</div> -->
		...
		<div class="footer-top">
			<div class="inner-wrap">
				...
				<a href="booking#layer_looking_theater"
