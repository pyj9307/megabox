...
function jusoCallBack(roadFullAddr){
 ...
 document.form.roadFullAddr.value = roadFullAddr;
    ...
    /* 회원삭제 deleteMember 추가 */
    function deleteMember() {
		
    	var f = document.form;
		f.action="<%=cp%>/movie/delete";
		f.submit();
		alert("회원 탈퇴 성공!!!!!");
	}
						...
						<form action="" method="post" name="form">
							<div class="table_join">
								<table>
									...
									<tbody>
										<tr>
											<!-- longid를 세션에서 히든으로 가져오는 걸로 -->
											<input type="hidden" value="${sessionScope.customInfo.longid}" name="longid" id="longid">
											<th>아이디</th>
											<td><input type="text" value="${sessionScope.customInfo.id}" name="id" id="id" class="type01" readOnly><%-- ${customInfo.id } --%> <!-- <input type="text" name="id" id="id" class="type01"> -->
											</td>
										</tr>
										<tr>
											<th>이름</th>
											<td><input type="text" value="${sessionScope.customInfo.name }" id="name" name="name"> </input></td>
											<%-- <td>${dto.name }</td> --%>
										</tr>
										<tr>
											<th>패스워드</th>
											<td><input type="password" name="pwd" id="pwd"
												value="${sessionScope.customInfo.pwd }" class="type01"></td>
										</tr>
										<tr>
											<th>패스워드 재확인</th>
										...
										<tr>
											...
											<td class="txt_color"><input type="text" name="email1"
												value="${sessionScope.customInfo.email1 }" class="type01"> @ <input
												type="text" name="email2" id="email2" value="${sessionScope.customInfo.email2 }"
										...
										<tr>
											<th>주소</th>
											<!-- 주소에서 id나 name을 대문자를 써야 값이 들어감. 그러면 수정 시 값이 안 들어감. -->
											<td></br> <input type="text" id="roadFullAddr"
												name="roadFullAddr" value="${sessionScope.customInfo.roadfulladdr }" size="60" />
							...
							<div class="btn-group mt40">							
								...
								<button type="button" id="" class="button purple large" onclick="deleteMember();">회원탈퇴</button>
