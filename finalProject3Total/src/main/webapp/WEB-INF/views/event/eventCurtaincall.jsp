				...
				<div class="tab-list fixed">
					<ul>
						...
						<li id="eventTab_"><a href="/event/event" title="전체">전체</a></li>
							...
							<li id="eventTab_CED04" class="on"><a href="/event/eventCurtaincall" title="시사회/무대인사 탭으로 이동">시사회/무대인사</a></li>
	...
	<div class="inner-wrap">
			...
			<div class="event-list ">
				...
				<ul>
					...
					<li>
						<a href="/event/curtaincall#" data-no="12623" data-netfunnel="N" class="eventBtn" title="&lt;서치 2&gt; 다니엘 헤니 무대인사 상세보기">
					...
					<li>
						<a href="/event/curtaincall#" data-no="12606" data-netfunnel="N" class="eventBtn" title="&lt;다음 소희&gt; 개봉기념 무대인사 상세보기">
					...
					<li>
						<a href="/event/curtaincall#" data-no="12603" data-netfunnel="N" class="eventBtn" title="&lt;카운트&gt; 메가박스 회원 시사회 상세보기">
					...
					<li>
						<a href="/event/curtaincall#" data-no="12574" data-netfunnel="N" class="eventBtn" title="&lt;서치 2&gt; 메가박스 회원 시사회 상세보기">
...
<section id="saw_movie_regi" class="modal-layer"><a href="/event/curtaincall" class="focus">레이어로 포커스 이동 됨</a>
...
<div class="quick-area">
	<a href="/event/curtaincall" class="btn-go-top" title="top">top</a>
</div>
